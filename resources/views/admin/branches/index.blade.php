                ...
                <div class="kt-portlet__body kt-portlet__body--fit">
                    ...
                    <div class="kt-container  kt-container--fluid  kt-grid__item kt-grid__item--fluid">
                        ...
                        <div class="kt-portlet__head-label mt-3">
                            ...
                            <button class="btn btn-brand btn-elevate btn-icon-sm confirmDel" disabled onclick="deleteAllData('more','{{route('admin.branches.destroy',0)}}')" data-toggle="modal" data-target="#confirm-all-del">
