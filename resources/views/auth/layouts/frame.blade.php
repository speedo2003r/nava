...
<head>
    ...
    <link href="./assets/css/demo1/pages/login/login-6.rtl.css" rel="stylesheet" type="text/css" />
    <!--end::Page Custom Styles -->

    <!--begin:: Global Mandatory Vendors -->
    <link href="./assets/vendors/general/perfect-scrollbar/css/perfect-scrollbar.rtl.css" rel="stylesheet"
        type="text/css" />
    ...
    <link href="./assets/css/demo1/skins/brand/dark.rtl.css" rel="stylesheet" type="text/css" />
    <link href="./assets/css/demo1/skins/aside/dark.rtl.css" rel="stylesheet" type="text/css" />
    <!--end::Layout Skins -->
