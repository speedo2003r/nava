...
var KTBootstrapDaterangepicker = function () {
    ...
    var demos = function () {
        ...
        $('#kt_daterangepicker_1, #kt_daterangepicker_1_modal').val(GetURLParameter('date_range'));

        $('#kt_daterangepicker_1, #kt_daterangepicker_1_modal').on('cancel.daterangepicker', function(ev, picker) {
          //do something, like clearing an input
          $('#kt_daterangepicker_1, #kt_daterangepicker_1_modal').val('');
        });
