        ...
        $("#kt_dropzone_1").dropzone({
            ...
            function () {
                ...
                t.on("addedfile", function (o) {
                    ...
                    document.querySelector(e + " .progress-bar").style.opacity = "1", o.previewElement.querySelector(e + " .dropzone-start").setAttribute("disabled", "disabled")
            ...
            function () {
                ...
                t.on("addedfile", function (o) {
                    ...
                    document.querySelector(e + " .progress-bar").style.width = o + "%"
                }), t.on("sending", function (o) {
