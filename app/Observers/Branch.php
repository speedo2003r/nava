...
use App\Entities\Branch as CategoryModel;
...
class Branch
{
    ...
    {
        $text = 'قام ' . $this->user . '' . ' أضافة فرع ' . $category->title;
    ...
    {
        $text = 'قام ' . $this->user . '' . ' تحديث فرع ' . $category->title;
        $this->report->create(['desc' => $text]);
    }
    ...
    {
        $text = 'قام ' . $this->user . '' . ' حذف فرع ' . $category->title;
        $this->report->create(['desc' => $text]);
    }
    ...
    {
        $text = 'قام ' . $this->user . '' . 'حذف فرع نهائيا ' . $category->title;
        $this->report->create(['desc' => $text]);
    }
}
