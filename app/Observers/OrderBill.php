...
use App\Entities\OrderBill as CategoryModel;
...
class OrderBill
{
    ...
    {
        $text = 'قام ' . $this->user . '' . ' أضافة فاتوره ' . $category->title;
    ...
    {
        $text = 'قام ' . $this->user . '' . ' تحديث فاتوره ' . $category->title;
        $this->report->create(['desc' => $text]);
    }
    ...
    {
        $text = 'قام ' . $this->user . '' . ' حذف فاتوره ' . $category->title;
        $this->report->create(['desc' => $text]);
    }
    ...
    {
        $text = 'قام ' . $this->user . '' . 'حذف فاتوره نهائيا ' . $category->title;
        $this->report->create(['desc' => $text]);
    }
}
