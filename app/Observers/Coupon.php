...
use App\Entities\Coupon as CategoryModel;
...
class Coupon
{
    ...
    {
        $text = 'قام ' . $this->user . '' . ' أضافة كوبون ' . $category->title;
    ...
    {
        $text = 'قام ' . $this->user . '' . ' تحديث كوبون ' . $category->title;
        $this->report->create(['desc' => $text]);
    }
    ...
    {
        $text = 'قام ' . $this->user . '' . ' حذف كوبون ' . $category->title;
        $this->report->create(['desc' => $text]);
    }
    ...
    {
        $text = 'قام ' . $this->user . '' . 'حذف كوبون نهائيا ' . $category->title;
        $this->report->create(['desc' => $text]);
    }
}
